...
# mod_aba_coreset <- create_module_bf(compendium = "vespucci", biofeaturesNames = aba_genes)
...
# set.seed(1)
# res <- biclust(impdata, method=BCPlaid(), verbose=FALSE)
```
...
#       impdata[which(res@RowxNumber[, num]), which(res@NumberxCol[num, ])]
```
