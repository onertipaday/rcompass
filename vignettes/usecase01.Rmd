...
```{r}
p = plotDistribution(biofeaturesNames = gene_names, samplesetNames =  colnames(module_1), type = "json", useIds = FALSE, plot = TRUE)
p
```
...
# module_2 <- create_module_bf(biofeaturesNames= top_30_bf, version = "legacy")
