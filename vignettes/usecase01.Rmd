...
tmpDir <- tempfile()
dir.create(tmpDir)
htmlFile <- file.path(tmpDir, "plot_heatmap.html")
xml2::write_html(h, tmpDir,file = htmlFile)
rstudioapi::viewer(htmlFile)
```

or using the json result and plotly in R
...
# tmpDir <- tempfile()
# dir.create(tmpDir)
# htmlFile <- file.path(tmpDir, "plot_network.html")
# xml2::write_html(h, tmpDir,file = htmlFile)
# rstudioapi::viewer(htmlFile)
view_plot(module = module_1, type = "network", threshold = 0.2)
```
...
# tmpDir <- tempfile()
# dir.create(tmpDir)
# htmlFile <- file.path(tmpDir, "plot_dist.html")
# xml2::write_html(h, tmpDir,file = htmlFile)
# rstudioapi::viewer(htmlFile)
view_plot(module = module_1, type = "distribution")
```
...
tmpDir <- tempfile()
dir.create(tmpDir)
htmlFile <- file.path(tmpDir, "plot_heat3.html")
xml2::write_html(h, tmpDir,file = htmlFile)
rstudioapi::viewer(htmlFile)
