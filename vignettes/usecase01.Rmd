...
knitr::kable(get_sampleset_id(name_In = colnames(module_1), normalization = "legacy"))
```
...
unsorted_ss <- get_sampleset_id(name_In = colnames(module_1), normalization = "legacy")
